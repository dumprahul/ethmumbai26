...
function StatusLine() {
  return (
    <div className="flex items-center gap-2 text-[10px] tracking-widest text-muted-foreground uppercase font-mono">
      ...
      <span>Proofs verified on Base · Wallets by BitGo</span>
    </div>
  )
}
...
const TIERS: Tier[] = [
  {
    ...
    period: "/ always",
    tag: null,
    description: "Join events with zero-knowledge proofs. No email, no doxxing.",
    features: [
      { text: "Generate ZK proofs locally", included: true },
      { text: "BitGo-powered wallet", included: true },
      { text: "Ticket on Base", included: true },
      { text: "No personal data shared", included: true },
      { text: "Private entry at venue", included: true },
  ...
  },
  {
    ...
    period: "/ launch",
    tag: "RECOMMENDED",
    description: "Create gated events. Verify eligibility on-chain. No data liability.",
    features: [
      { text: "Set eligibility (age, membership)", included: true },
      { text: "ZK verification on Base", included: true },
      { text: "Ticket minting & transfer", included: true },
      { text: "No attendee PII stored", included: true },
      { text: "Analytics (aggregate only)", included: true },
  ...
  },
  {
    ...
    period: "",
    tag: null,
    description: "Private events, members-only access, compliance-friendly.",
    features: [
      { text: "All Organizer features", included: true },
      { text: "Custom proof circuits", included: true },
      { text: "SSO / identity integration", included: true },
      { text: "Audit logs & compliance", included: true },
      { text: "Dedicated support", included: true },
      { text: "On-prem / private chain", included: true },
    ],
    cta: "CONTACT US",
    highlighted: false,
  },
...
export function PricingSection() {
  return (
    <section className="w-full px-6 py-20 lg:px-12">
      ...
      >
        <div className="flex flex-col gap-3">
          <h2 className="text-2xl lg:text-3xl font-mono font-bold tracking-tight uppercase text-foreground text-balance">
            Attend. Organize. Scale.
          </h2>
          <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed max-w-md">
            Whether you’re joining an event or running one, Disco keeps identity private and verification on-chain.
          </p>
        </div>
        <StatusLine />
      </motion.div>
      ...
      >
        <span className="text-[10px] tracking-[0.2em] uppercase text-muted-foreground font-mono">
          {"* Privacy by design. No PII stored. Verification on Base."}
        </span>
        <div className="flex-1 border-t border-border" />
      </motion.div>
    </section>
