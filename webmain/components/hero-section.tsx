  ...
  return (
    <section className="relative w-full px-12 pt-6 pb-12 lg:px-24 lg:pt-10 lg:pb-16">
      <div className="flex flex-col items-center text-center">
        ...
        >
          Prove you meet event requirements with zero-knowledge proofs. No email, no name, no exposed wallet history—just a cryptographic proof that you’re eligible. Events on Base. Wallets by BitGo.
        </motion.p>
