...
const LOG_LINES = [
  "> Disco // privacy-preserving events",
  "> Loading event: ETH Mumbai 2026",
  "> Requirement: age >= 21",
  "> Generating ZK proof locally...",
  "> Proof circuit: 1/3",
  "> Proof circuit: 2/3",
  "> Proof circuit: 3/3",
  "> Proof generated. No data leaked.",
  "> Creating wallet via BitGo...",
  "> Wallet ready. Submitting proof.",
  "> Verifying on Base contract...",
  "> Verification: PASS",
  "> Ticket minted to your wallet.",
  "> --------- READY TO ENTER ---------",
]
