...
const REGIONS = [
  { name: "BASE_MAINNET", status: "ONLINE", latency: "Contracts" },
  { name: "BITGO_WALLET", status: "ONLINE", latency: "Ready" },
  { name: "ZK_VERIFIER", status: "ONLINE", latency: "Live" },
  { name: "TICKET_NFT", status: "ONLINE", latency: "Minted" },
]
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col p-4 gap-0">
        ...
        <div className="grid grid-cols-3 gap-2 border-b border-border pb-2 mb-2">
          <span className="text-[9px] tracking-[0.15em] uppercase text-muted-foreground">Component</span>
          <span className="text-[9px] tracking-[0.15em] uppercase text-muted-foreground">Status</span>
          <span className="text-[9px] tracking-[0.15em] uppercase text-muted-foreground text-right">Info</span>
        </div>
        {REGIONS.map((region) => (
          <div
            key={region.name}
