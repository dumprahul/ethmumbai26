  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col justify-center gap-6 p-6">
        <ScrambleNumber target="0" label="Data exposed" delay={500} />
        <ScrambleNumber target="100%" label="Privacy preserved" delay={800} />
        <ScrambleNumber target="Base" label="Verification chain" delay={1100} />
        <ScrambleNumber target="ZK" label="Proof verification" delay={1400} />
      </div>
    </div>
  )
}
