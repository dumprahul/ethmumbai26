...
/* ── stat block ── */
const STATS = [
  { label: "DATA_EXPOSED", value: "0" },
  { label: "PROOFS_VERIFIED", value: "ZK" },
  { label: "TICKETS_ON", value: "Base" },
  { label: "WALLETS_VIA", value: "BitGo" },
]
        ...
        >
          ...
          <div className="absolute top-0 left-0 right-0 z-10 flex items-center justify-between px-4 py-2 bg-foreground/80 backdrop-blur-sm">
            <span className="text-[10px] tracking-[0.2em] uppercase text-background/60 font-mono">
              RENDER: disco_privacy_stack.obj
            </span>
          ...
          <Image
            ...
            alt="Privacy-preserving event stack: ZK proofs, BitGo, Base"
            fill
          ...
          <div className="flex-1 flex flex-col justify-between px-5 py-6 lg:py-8">
            <div className="flex flex-col gap-6">
              ...
              >
                Events without
                <br />
                <span className="text-[#ea580c]">exposing you</span>
              </motion.h2>
              ...
              >
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  Event platforms today force you to hand over emails, names, or wallet addresses just to RSVP. In Web3, connecting a wallet exposes your entire on-chain history. Disco flips that: you prove you meet requirements—age, membership, eligibility—using zero-knowledge proofs. Organizers verify. You stay private.
                </p>
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  Wallets are created and managed via BitGo. Verification and tickets live on smart contracts on Base. You generate proofs locally, the contract checks them, and you get a ticket. No personal data, no on-chain footprint. Secure, private, scalable.
                </p>
              </motion.div>
              ...
              >
                ...
                <span className="text-[10px] font-mono text-foreground">ZK · BitGo · Base</span>
              </motion.div>
            </div>
